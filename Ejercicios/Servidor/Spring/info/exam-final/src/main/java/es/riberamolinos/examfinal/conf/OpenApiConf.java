package es.riberamolinos.examfinal.conf;
...
public class OpenApiConf {
	...
	OpenAPI myOpenAPI() {
		...
		Info info = new Info().title("Mi api rest de examen").version("1.0").description("This API exposes endpoints.")
				.termsOfService("https://www.ayuda.com/terms")
				.license(new License().name("MIT License").url("https://choosealicense.com/licenses/mit/"))
				.contact(new Contact().email("Paco@gmail.com").name("Antonio").url("https://www.forocoches.com"));
